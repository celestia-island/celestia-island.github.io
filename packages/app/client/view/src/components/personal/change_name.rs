...
use _client_functions::secure::update_personal_name;
...
#[styled_component]
pub fn ChangeName(props: &Props) -> HtmlResult {
                            ...
                            onclick={
                                ...
                                move |_| {
                                    ...
                                    wasm_bindgen_futures::spawn_local(async move {
                                        if update_personal_name(new_name, confirm_password).await.is_ok() {
                                            onclose.emit(());
                                            gloo::dialogs::alert("Successfully changed name");
                                            gloo::utils::window().location().reload().unwrap();
                                        } else {
                                            gloo::dialogs::alert("Failed to change name");
                                        }
                                    });
                                }
                            }
